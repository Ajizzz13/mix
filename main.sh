...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m                        ZE VPN STORE             \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Ajizzz13/mix/main/izin-ip-sandz | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Ajizzz13/mix/main/izin-ip-sandz | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/Ajizzz13/mix/main/izin-ip-sandz | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/Ajizzz13/mix/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Ajizzz13/mix/main/izin-ip-sandz | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Ajizzz13/mix/main/izin-ip-sandz | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"order","url":"https://wa.me/+6281248594879"},{"text":"install","url":"https://t.me/ZeVpnPremium"}]]}'
...
wget raw.githubusercontent.com/Ajizzz13/mix/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
